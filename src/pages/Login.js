...
import { FormControl, FormLabel, Input, Button, Heading, FormErrorMessage, Text } from '@chakra-ui/react';
        ...
        <div style={centerStyles}>
            ...
            >
                ...
                <FormControl display="flex" flexDirection="column">
                    <FormControl isInvalid={isErrorPassword} isRequired>
                        ...
                        >
                            ...
                            />
                            <label style={{ marginLeft: '5px', fontSize: '10px' }}>Show Password</label>
                        </div>
                        {!isErrorPassword ? (
                            <div style={{ marginBottom: '10px' }}></div>
                        ) : (
                ...
                <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'row' }}>
                    <span style={{ marginLeft: '55px' }}>Don't have an account? Click here to</span>
