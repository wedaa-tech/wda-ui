            ...
            >
              ...
              >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleProjectData("projectName", e.target.value)
                  }
                ></Input>
                {projectData.projectName && projectNameCheck && (
                ...
                <div
                  className={`dndnode output`}
                  onDragStart={(event) =>
                    onDragStart(event, "default", "Gateway")
                  }
                  draggable
                >
                  Gateway
                ...
                <div
                  className="dndnode output"
                  onDragStart={(event) =>
                    onDragStart(event, "default", "Service")
                  }
                  draggable
                >
                  Service
                ...
                <div
                  className="dndnode output"
                  onDragStart={(event) =>
                    onDragStart(event, "default", "Group")
                  }
                  draggable
                >
                  Group
                ...
                {refArch.map((element) => {
                  ...
                  return (
                    <Box
                      width={"90%"}
                      onDragStart={(event) =>
                        onDragStart(event, "marketNode", "marketNode", metadata)
                      }
                      draggable
                    >
