...
import { Container, FormControl, FormLabel, Select, Input, Button, Heading, FormErrorMessage, Flex } from '@chakra-ui/react';
...
function FormWdi(props) {
    ...
    const validateInputs = () => {
        if (projectName === '' || domain === '' || awsAccountId === '' || checkLength || clusterName === '') {
            return true;
        } else {
            return false;
        }
            ...
            <FormControl>
                {!isContainerVisible && !generateInfrastructure && (
                    <>
                        ...
                        <Select marginBottom="10px" onChange={e => setCloudProvider(e.target.value)} value={cloudProvider}>
                            ...
                            <>
                                <FormControl isInvalid={isErrorAccId} isRequired>
                                    ...
                                    {!isErrorAccId ? (
                                        ...
                                        <FormErrorMessage marginBottom="10px" fontSize="10px" marginTop="5px">
                                            <WarningIcon marginRight="5px" />
                                            {checkLength ? 'Input value must be at least 12 digits' : 'Required'}
                                        </FormErrorMessage>
                                    )}
                                </FormControl>
                                <FormLabel>Select region</FormLabel>
                                <Select marginBottom="10px" onChange={e => setAwsRegion(e.target.value)} value={awsRegion}>
                        ...
                        <Select onChange={e => setOrchestration(e.target.value)} value={orchestration} marginBottom="10px">
              ...
              (<div>
                ...
                >
                  ...
                  /> */}
                                ...
                                <Select onChange={e => setIngress(e.target.value)} value={ingress} marginBottom="10px">
                                    <option value="istio">Istio</option>
                                    <option value="nginx">Nginx</option>
                                    <option value="traefik">Traefik</option>
                                </Select>
                                <FormLabel>Enable Monitoring:</FormLabel>
                                <Select onChange={e => setMonitoring(e.target.value)} value={monitoring} marginBottom="10px">
                                    <option value="true">Yes</option>
                                    <option value="false">No</option>
                                </Select>
                                <FormLabel>Enable Elastic Cloud:</FormLabel>
                                <Select onChange={e => setEnableECK(e.target.value)} value={enableECK} marginBottom="10px">
                                    <option value="true">Yes</option>
                                    <option value="false">No</option>
                                </Select>
                                <FormLabel>Enable Web UI:</FormLabel>
                                <Select onChange={e => setK8sWebUI(e.target.value)} value={k8sWebUI} marginBottom="10px">
                                    <option value="true">Yes</option>
                                    <option value="false">No</option>
                                </Select>
                            </div>
