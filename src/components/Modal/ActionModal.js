                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogBody>
                        {actionType === 'delete' ? (
                            ...
                            <>Navigating away from this page without saving will lead to the loss of any unsaved changes</>
                        )}
                    </AlertDialogBody>
                    ...
                    <AlertDialogFooter>
                        ...
                        <Button colorScheme={actionType === 'delete' ? 'red' : 'blue'} onClick={() => onSubmit({ id })} ml={3}>
