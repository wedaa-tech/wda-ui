...
const UIGatewayService = ({
    ...
    const packageNameCheck = GatewayData.packageName && !/^[a-zA-Z](?:[a-zA-Z0-9_.-]*[a-zA-Z0-9])?$/g.test(GatewayData.packageName);
    ...
    console.log(nodeType, 'ppppppppp');
    ...
    useEffect(() => {
        const handleDeleteKeyPress = event => {
            if (
                ...
                (nodeType !== 'UI' || event.target.tagName !== 'TEXTAREA')
            ) {
                onClose();
            }
        };
                            ...
                            <>
                                <FormControl>
                                    ...
                                    <Input
                                        ...
                                        borderColor={'black'}
                                        maxLength="32"
                                        value={nodeType === 'UI' ? UiData.label : GatewayData.label}
                                ...
                                <FormControl>
                                    ...
                                    <Input
                                        ...
                                        maxLength="32"
                                        value={nodeType === 'UI' ? UiData.applicationName : GatewayData.applicationName}
                        ...
                        {nodeType !== 'Group' && nodeType !== 'Dummy' && (
                            <FormControl>
                                ...
                                <Input
                                    ...
                                    value={nodeType === 'UI' ? UiData.serverPort : GatewayData.serverPort}
                                    maxLength="5"
...
export default UIGatewayService;
