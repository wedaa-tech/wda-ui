...
const DeploymentModal = ({
    ...
    return (
        <>
            <Modal isOpen={cloudModal} onClose={handleContainerClose} isCentered={true}>
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader>
                    ...
                    >
                        ...
                        {cloudName === 'aws' && (
                            <div>
                                ...
                                <FormControl>
                                    ...
                                    <Select mb={4} variant="outline" id="awsRegion" borderColor={'black'} value={awsRegion} disabled={true}>
                        ...
                        {deploymentType === 'kubernetes' && (
                            <div>
                                ...
                                {kubernetesUseDynamicStorage === 'true' && cloudName !== 'azure' && (
                                    <FormControl>
                                ...
                                <FormControl>
                                    ...
                                    <Select mb={4} variant="outline" id="k8sWebUI" borderColor={'black'} value={k8sWebUI} disabled={true}>
                                        <option value="" disabled>
                                            Select an option
                                        </option>
                                        <option value="true">Yes</option>
