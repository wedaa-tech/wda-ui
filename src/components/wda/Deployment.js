...
import { FormControl, FormLabel, Input, Select, Text, FormErrorMessage } from '@chakra-ui/react';
    ...
    return (
        <FormControl>
            ...
            <Select
                key="deploymentType"
                name="deploymentType"
                onChange={({ target }) => handleInputChange('deploymentType', target.value)}
                marginBottom="10px"
            ...
            {Object.values(application).filter(app => app.applicationName !== '').length > 0 && (
                <>
            ...
            <FormControl isInvalid={isErrorRepoName} isRequired>
                ...
                <Input
                    ...
                    onChange={({ target }) => handleInputChange('dockerRepositoryName', target.value)}
            ...
            <FormControl isInvalid={isErrorNamespace} isRequired>
                ...
                <Input
                    ...
                    onChange={({ target }) => handleInputChange('kubernetesNamespace', target.value)}
      ...
      >
        ...
        <option value="ingress">Ingress</option>
            ...
            <Select
                ...
                onChange={({ target }) => handleInputChange('kubernetesUseDynamicStorage', target.value)}
                marginBottom="10px"
      ...
      /> */}
            ...
            <Select
                key="ingressType"
                name="ingressType"
                onChange={({ target }) => handleInputChange('ingressType', target.value)}
                marginBottom="10px"
            ...
            <FormControl isInvalid={isErrorIngressDomain} isRequired>
                ...
                <Input
                    ...
                    key="ingressDomain"
                    name="ingressDomain"
                    onChange={({ target }) => handleInputChange('ingressDomain', target.value)}
