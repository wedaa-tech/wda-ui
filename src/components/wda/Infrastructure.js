    ...
    return (
        <FormControl>
            ...
            <Select
                ...
                key="cloudProvider"
                name="cloudProvider"
                onChange={({ target }) => handleInputChange('cloudProvider', target.value)}
                ...
                <>
                    <FormControl isInvalid={isErrorAccId} isRequired>
                        ...
                        <Input
                            ...
                            onChange={({ target }) => handleInputChange('awsAccountId', target.value)}
                    ...
                    <Select
                        marginBottom="10px"
                        onChange={({ target }) => handleInputChange('awsRegion', target.value)}
            ...
            <Select
                key="orchestration"
                name="orchestration"
                onChange={({ target }) => handleInputChange('orchestration', target.value)}
        ...
        <div>
                ...
                <div>
                    <FormControl isInvalid={isErrorCluster} isRequired>
                        ...
                        <Input
                            ...
                            key="clusterName"
                            name="clusterName"
                            onChange={({ target }) => handleInputChange('clusterName', target.value)}
          ...
          /> */}
                    ...
                    <Select
                        key="ingress"
                        name="ingress"
                        onChange={({ target }) => handleInputChange('ingress', target.value)}
                    ...
                    <Select
                        onChange={({ target }) => handleInputChange('enableECK', target.value)}
                    ...
                    <Select
                        onChange={({ target }) => handleInputChange('k8sWebUI', target.value)}
