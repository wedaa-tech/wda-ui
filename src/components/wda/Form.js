...
function FormWda() {
    ...
    const validateInfra = () => {
        if (wdi.domain === '' || wdi.awsAccountId === '' || wdi.clusterName === '') {
            return true;
        } else {
            return false;
        }
    ...
    return (
        <>
            <Modal isOpen={isOpen}>
                ...
                <ModalContent>
                    <ModalHeader>
                        <h2 style={{ display: 'inline-block' }}>Please enter your details</h2>
                    ...
                    <ModalBody>
                        Enter username
                        <Input type="text" marginBottom="10px" onChange={e => setUsername(e.target.value)} value={username} />
                        Enter project name
                        <Input type="text" marginBottom="10px" onChange={e => setProjectName(e.target.value)} value={projectName} />
                        <Checkbox defaultChecked={generateInfrastructure} onChange={handleCheckboxChange}>
                            Generate infrastructure
                        </Checkbox>
                    </ModalBody>
                    <ModalFooter>
                        <Button colorScheme="blue" onClick={handleContainerClose} isDisabled={!username || !projectName}>
                            Next
                        </Button>
                    </ModalFooter>
                </ModalContent>
            ...
            {!isContainerVisible && (
                <Container maxW="2xl" marginTop="16px">
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        {generateInfrastructure && <Heading marginBottom="10px">& WDI</Heading>}
                    </div>
                ...
                >
                  Add
                            ...
                            <TabPanel>
                                ...
                                {Object.values(application).filter(app => app.applicationName !== '').length >= 2 && (
                                    <Button
                                        width="100px"
                                        border="2px"
                                        borderColor="green.500"
                            ...
                            <TabPanel>
                                <Deployment application={application} deployment={deployment} setDeployment={setDeployment} />
                                {!generateInfrastructure && (
                                    <>
                                        <Button
                                            width="100px"
                                            ...
                                            marginTop="10px"
                                            isDisabled={isDuplicateAppName || validateApplication() || validateDeployment()}
                                        >
                                            Submit
                                        </Button>
                                        {isLoading && (
                                        ...
                                        {validateApplication() ? (
                                            ...
                                            >
                                                Please ensure all the mandatory fields in Application are filled
                                            </p>
                                        ) : null}
                                        {validateDeployment() ? (
                                            <p
                                            ...
                                            >
                                                Please ensure all the mandatory fields in Deployment are filled
                                            </p>
                                        ) : null}
                                    </>
                                )}
                            ...
                            {generateInfrastructure && (
                                <TabPanel>
                                    ...
                                    {validateInfra() ? (
                                        ...
                                        >
                                            Please ensure all the mandatory fields in Infrastruture are filled
                                        </p>
                                    ) : null}
                                </TabPanel>
                            )}
